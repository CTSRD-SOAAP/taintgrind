...
typedef enum {
	...
	VG_USERREQ__TAINTGRIND_READ_SHARED_FD,
	VG_USERREQ__TAINTGRIND_WRITE_SHARED_FD,
	VG_USERREQ__TAINTGRIND_READ_SHARED_VAR,
	VG_USERREQ__TAINTGRIND_WRITE_SHARED_VAR,
...
#define TNT_READ_SHARED_FD(fd) \
		VALGRIND_DO_CLIENT_REQUEST_STMT(VG_USERREQ__TAINTGRIND_READ_SHARED_FD, fd, 0, 0, 0, 0);

#define TNT_WRITE_SHARED_FD(fd) \
		VALGRIND_DO_CLIENT_REQUEST_STMT(VG_USERREQ__TAINTGRIND_WRITE_SHARED_FD, fd, 0, 0, 0, 0);

#define TNT_READ_SHARED_VAR(var) \
		VALGRIND_DO_CLIENT_REQUEST_STMT(VG_USERREQ__TAINTGRIND_READ_SHARED_VAR, var, 0, 0, 0, 0)

#define TNT_WRITE_SHARED_VAR(var) \
		VALGRIND_DO_CLIENT_REQUEST_STMT(VG_USERREQ__TAINTGRIND_WRITE_SHARED_VAR, var, 0, 0, 0, 0)
